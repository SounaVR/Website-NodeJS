...
module.exports = (passport) => {
    ...
    passport.use(new GoogleStrategy({
        ...
        callbackURL: 'https://souna.ovh/node/auth/google/callback',
        passReqToCallback: true
    ...
    passport.use(new DiscordStrategy({
        ...
        callbackURL: 'https://souna.ovh/node/auth/discord/callback',
        passReqToCallback: true,
        scope: scopes
    ...
    passport.use(new GitHubStrategy({
        ...
        callbackURL: 'https://souna.ovh/node/auth/github/callback',
        passReqToCallback: true
